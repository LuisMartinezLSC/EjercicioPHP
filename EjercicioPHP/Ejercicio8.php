...
<html lang="es">
  ...
  <li role="presentacion" class="active"><a href="index.php">Inicio</a></li>
             ...
             <center><h3>Desarrollar un formulario que pida un número del 1 al 7 y diga el día de la semana correspondiente.</h3></center>   
                    <br>
                 <br>
                 <br>
                 <br>
                 <br>
        <center><form name="formulario" method="post" action="Formulario8.php">
        Numero del dia de la semana: <input type="text" name="dia" value="">   
        ...
        <br>    
            <center><nav aria-label="Page navigation">
              <ul class="pagination">
                <li>
                  <a href="Ejercicio7.php" aria-label="Previous">
                ...
                <li>
                  <a href="Ejercicio9.php" aria-label="Next">
