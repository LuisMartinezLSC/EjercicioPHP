...
<html lang="es">
  ...
  <li role="presentacion" class="active"><a href="index.php">Inicio</a></li>
             ...
             <center><h3>Introducir el número de la tabla de multiplicar y mostrar en pantalla la tabla completa.</h3></center>   
                    <br>
                 <br>
                 <br>
                 <br>
                 <br>
        <center><form name="formulario" method="post" action="Formulario10.php">
        Numero de tabla  a multiplicar: <input type="text" name="tabla" value="">   
        ...
        <br>    
            <center><nav aria-label="Page navigation">
              <ul class="pagination">
                <li>
                  <a href="Ejercicio9.php" aria-label="Previous">
                ...
                <li><a href="Ejercicio9.php">10</a></li>
